...
function bitsy_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bitsy' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bitsy' ),
...
function bitsy_scripts() {
	...
	wp_enqueue_script( 'bitsy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bitsy-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
